...
class ConnectionObject : public CIPClass
{
    ...
    public:
         ...
         */
        CipStatus ConnectionManagerInit(CipUint unique_connection_id);
    ...
    /* Beginning of instance info */
        ...
        */
        ...
        value than SequenceCountProducing */
         CipUdint eip_level_sequence_count_consuming; /* the EIP level sequence Count
        for Class 0/1
        Producing Connections may have a
        different
        value than SequenceCountProducing */
